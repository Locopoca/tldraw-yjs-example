...
let NFT_ABI = [
  ...
  const useCheckNftOwnership = (contractAddress: string) => {
    ...
    }, [isConnected, address, web3, getNFTBalance]);
  
    return hasNFT;
  };
  
  export default useCheckNftOwnership;